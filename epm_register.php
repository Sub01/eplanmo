                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-md-6 mb-4">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="tel" name="cno" required="" placeholder="Contact (09**** or +63*****)" onKeyPress="if(this.value.length==14) return false;" style="width: 100%" pattern="^(09|\+639)\d{9}$">
                                            </div>
                                            <div class="form-group">
