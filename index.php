...
<nav class="navbar navbar-expand-lg" style="background-color:maroon">
 ...
 <?php 
    ...
    $pomo = $gim['Images'];
    echo '<div class="wrapper d-flex" style="height:500px;background-repeat: no-repeat; background-size: cover; background-image:url(data:image/jpeg;base64,'.base64_encode($pomo).');">'
?>
