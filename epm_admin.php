                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                ?>
                                <a class="dropdown-item d-flex align-items-center" href="assets/php/update_notif_admin.php?id=<?php echo $row2['ID']?>">
                                    <div class="mr-3">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                            ...
                            <a class="dropdown-item" href="https://eplanmo.herokuapp.com/session_logout.php" onclick="return confirm('Are you sure you want to Log Out?')">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-4 col-sm-4 mb-4">
                                <div class="card border-left-warning shadow h-100 py-2" style="border-left-style: solid; border-left-width: thick; border-left-color:rgb(0, 123, 255) ">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                            ...
                            <div class="col-xl-4 col-md-4 col-sm-4 mb-4">
                                <div class="card border-left-dark shadow h-100 py-2" style="border-left-style: solid; border-left-width: thick; border-left-color:rgb(220, 53, 69)">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
